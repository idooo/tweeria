...
(function ($) {
    ...
    $.fn.cluetip = function (js, options) {
        ...
        return this.each(function (index) {
            ...
            if (!$("#cluetip").length) {
                ...
                $cluetipWait = $('<div id="cluetip-waitimage"></div>').css({position:"absolute"}).insertBefore($cluetip).hide();
            }
            ...
            var activate = function (event) {
                ...
                if (js) {
                    ...
                    if (tipParts) {
                        ...
                        if (!opts.local && tipAttribute.indexOf("#") !== 0) {
                            if (/\.(jpe?g|tiff?|gif|png)$/i.test(tipAttribute)) {
                                ...
                                if (cluetipContents && opts.ajaxCache) {
                                    ...
                                    var ajaxSettings = {cache:true, url:tipAttribute, beforeSend:function (xhr) {
                                        if (optionBeforeSend) {
            ...
            var cluetipShow = function (bpY) {
                ...
                if (opts.positionBy == "fixed") {
                    ...
                    if ((posX < mouseX && Math.max(posX, 0) + tipWidth > mouseX) || opts.positionBy == "bottomTop") {
                        ...
                        if (posY + tipHeight + tOffset > baseline) {
                            tipY = (tipHeight >= wHeight) ? sTop : baseline - tipHeight - tOffset;
                        } else {
                            if ($this.css("display") == "block" || link.tagName.toLowerCase() == "area" || opts.positionBy == "mouse") {
                                tipY = bpY - tOffset;
                            } else {
                ...
                if (opts.dropShadow) {
                    $dropShadow.css({height:tipHeight, width:tipInnerWidth, zIndex:$this.data("thisInfo").zIndex - 1}).show();
                }
                if ($.fn.bgiframe) {
                    $cluetip.bgiframe();
                }
            ...
            if ((/click|toggle/).test(opts.activation)) {
                ...
                if (opts.activation == "focus") {
                    ...
                    if ($.fn.hoverIntent && opts.hoverIntent) {
                        $this.hoverIntent({sensitivity:opts.hoverIntent.sensitivity, interval:opts.hoverIntent.interval, over:function (event) {
                            activate(event);
                            mouseTracks(event);
                        }, timeout:opts.hoverIntent.timeout, out:function (event) {
                            inactivate(event);
    ...
    $.fn.cluetip.defaults = {width:275, height:"auto", cluezIndex:97, positionBy:"mouse", topOffset:15, leftOffset:15, local:false, localPrefix:null, hideLocal:true, attribute:"rel", titleAttribute:"title", splitTitle:"", escapeTitle:false, showTitle:false, cluetipClass:"default", hoverClass:"", waitImage:false, cursor:"pointer", arrows:false, dropShadow:false, dropShadowSteps:6, sticky:false, mouseOutClose:false, activation:"hover", clickThrough:true, tracking:false, delayedClose:0, closePosition:"top", closeText:"Close", truncate:0, fx:{open:"show", openSpeed:""}, hoverIntent:{sensitivity:3, interval:50, timeout:0}, onActivate:function (e) {
        return true;
    }, onShow:function (ct, ci) {
    }, onHide:function (ct, ci) {
    }, ajaxCache:true, ajaxProcess:function (data) {
        if (!$.browser.msie) {
