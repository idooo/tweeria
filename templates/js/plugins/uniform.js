        ...
        uniformHandlers = [
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    /*Elfrey add*/
                    if (options.fileBackground!=""){
                        $div.find(".action").css({
                            "background": options.fileBackground
                        });
                    }
                    if (options.fileSizeW!=""){
                        $div.css({"width": options.fileSizeW})
                            .find(".action").css({"width": options.fileSizeW})
                            .end().find("input").css({"width": options.fileSizeW})
                    }
                    if (options.fileSizeH!=""){
                        $div.css({"height": options.fileSizeH})
                            .find(".action").css({"height": options.fileSizeH})
                            .end().find("input").css({"height": options.fileSizeH})
                    }
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    if (options.selectAutoWidth) {
                        ...
                        px = (options.selectWidth>0) ? options.selectWidth :  $el.width();
                        $div.width(px);
                        $span.width(px - 25);
                        if (options.selectWidth>0) {
                            $el.width(px+10);
                        }
                    }
